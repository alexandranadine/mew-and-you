/**
 * Mock "geocoding" for ZIP codes across LA County, standing in for a real
 * geocoding service until the backend exists. Covers the ZIPs used by
 * `mockCats.ts` plus a handful of others so a search doesn't only work for
 * the exact ZIPs cats happen to live in.
 */
